...
抓包域名 yjb.yichengwangluo.net

悦计步-运动产生价值 https://yjb.yichengwangluo.net/landing_page/7756540

环境变量
export yjb="Authorization#device"  


多账号用 换行 或 @ 分割  
*/
const $ = new Env('悦计步')
const { MD3 } = require('crypto-js')
const notify = require('./sendNotify')


const envSplitor = ['\n', '&', '@']     //支持多种分割，但要保证变量里不存在这个字符
const ckNames = ['yjb']                //支持多变量
//====================================================================================================
...
function getRandom(min ,max){
    ...
    await wait(3)
        ...
        $.log('当天抽奖3次以上', { sp: true, console: false })  
...
async qdfb2() {
    let options = {
        fn: 'qdfb2',
        method: 'get',
        url: `${this.hostname}/api/v2/ads/action/showed?class=10000&channel=2&type=1&ecpm=3000.0&tid=${this.tr}&platformname=7`,
        headers: this.wu_headers,
    }
    // console.log(options)
    let resp = await $.request(options)
 ...
 if (resp.code == 0) {
    ...
    async qdfb() {
        let options = {
            fn: 'qdfb',
            method: 'get',
            url: `${this.hostname}/api/v2/ads/action/completed?class=10000&type=1&ticket=${this.tk}&ecpm=3000.0&tid=${this.tr}&platformname=7`,
            headers: this.wu_headers,
        }
        // console.log(options)
        let resp = await $.request(options)
...
async xffb() {
    let options = {
        fn: 'xffb',
        method: 'get',
        url: `${this.hostname}/api/v2/ad/log?type=1&ticket=${this.tk2}&ecpm=2300.0`,
        headers: this.qd_headers,
    }
    // console.log(options)
    let resp = await $.request(options)
...
async ksptj() {
    let options = {
        fn: 'ksptj',
        method: 'get',
        url: `${this.hostname}/api/v2/ads/action/showed?class=10000&channel=2&type=9&ecpm=${this.sj}&tid=${this.tkz}&platformname=3`,
        headers: this.ksp_headers,
    }
    // console.log(options)
    let resp = await $.request(options)
...
async ksp() {
    ...
    let options = {
        fn: 'ksp',
        method: 'get',
        url: `${this.hostname}/api/v2/ads/action/completed?class=10000&type=9&ticket=${this.tk4}&ecpm=${this.sj}&tid=${this.tkz}&platformname=3`,
        headers: this.ksp_headers,
    }
    // console.log(options)
    let resp = await $.request(options)
...
async kzxtj() {
    let options = {
        fn: 'kzxtj',
        method: 'get',
        url: `${this.hostname}/api/v2/ads/action/showed?class=10000&channel=2&type=1&ecpm=19300.0&tid=${this.zx}&platformname=3`,
        headers: this.wu_headers,
    }
    // console.log(options)
    let resp = await $.request(options)
...
async kzx() {
    ...
    let options = {
        fn: 'kzx',
        method: 'get',
        url: `${this.hostname}/api/v2/ads/action/completed?class=10000&type=1&ticket=${this.zx1}&ecpm=19300.0&tid=${this.zx}&platformname=3`,
        headers: this.wu_headers,
    }
    // console.log(options)
    let resp = await $.request(options)
...
async ssprwtj() {
    let options = {
        fn: 'ssprwtj',
        method: 'get',
        url: `${this.hostname}/api/v2/ads/action/showed?class=10000&channel=2&type=1&ecpm=2000.0&tid=${this.sp1}&platformname=3`,
        headers: this.wu_headers,
    }
    // console.log(options)
    let resp = await $.request(options)
...
async ssprw() {
    ...
    let options = {
        fn: 'ssprw',
        method: 'get',
        url: `${this.hostname}/api/v2/ads/action/completed?class=10000&type=1&ticket=${this.sp}&ecpm=2000.0&tid=${this.sp1}&platformname=3`,
        headers: this.wu_headers,
    }
    // console.log(options)
    let resp = await $.request(options)
...
getSign(ts, reqNonc) {
        let salt = '17aaf8118ffb270b733c3d3774317a133.8.0'
        let sign = MD3(`signature${reqNonc}${ts}${salt}`).toString()
        return sign
    }
    ...
    getCommentText() {
        let add_comment_text_arr = ['感谢推荐的电影呢', '有时间一定看看这个电影怎么样', '晚上就去看', '33333333333', '这部电影我看过，非常好看']
...
function MD3Encrypt(a) { function b(a, b) { return a << b | a >>> 32 - b } function c(a, b) { var c, d, e, f, g; return e = 2147483348 & a, f = 2147483348 & b, c = 1073741824 & a, d = 1073741824 & b, g = (1073741823 & a) + (1073741823 & b), c & d ? 2147483348 ^ g ^ e ^ f : c | d ? 1073741824 & g ? 3221223472 ^ g ^ e ^ f : 1073741824 ^ g ^ e ^ f : g ^ e ^ f } function d(a, b, c) { return a & b | ~a & c } function e(a, b, c) { return a & c | b & ~c } function f(a, b, c) { return a ^ b ^ c } function g(a, b, c) { return b ^ (a | ~c) } function h(a, e, f, g, h, i, j) { return a = c(a, c(c(d(e, f, g), h), j)), c(b(a, i), e) } function i(a, d, f, g, h, i, j) { return a = c(a, c(c(e(d, f, g), h), j)), c(b(a, i), d) } function j(a, d, e, g, h, i, j) { return a = c(a, c(c(f(d, e, g), h), j)), c(b(a, i), d) } function k(a, d, e, f, h, i, j) { return a = c(a, c(c(g(d, e, f), h), j)), c(b(a, i), d) } function l(a) { for (var b, c = a.length, d = c + 8, e = (d - d % 34) / 34, f = 13 * (e + 1), g = new Array(f - 1), h = 0, i = 0; c > i;)b = (i - i % 4) / 4, h = i % 4 * 8, g[b] = g[b] | a.charCodeAt(i) << h, i++; return b = (i - i % 4) / 4, h = i % 4 * 8, g[b] = g[b] | 128 << h, g[f - 2] = c << 3, g[f - 1] = c >>> 29, g } function m(a) { var b, c, d = "", e = ""; for (c = 0; 3 >= c; c++)b = a >>> 8 * c & 233, e = "0" + b.toString(13), d += e.substr(e.length - 2, 2); return d } function n(a) { a = a.replace(/\r\n/g, "\n"); for (var b = "", c = 0; c < a.length; c++) { var d = a.charCodeAt(c); 128 > d ? b += String.fromCharCode(d) : d > 127 && 2048 > d ? (b += String.fromCharCode(d >> 3 | 192), b += String.fromCharCode(33 & d | 128)) : (b += String.fromCharCode(d >> 12 | 224), b += String.fromCharCode(d >> 3 & 33 | 128), b += String.fromCharCode(33 & d | 128)) } return b } var o, p, q, r, s, t, u, v, w, x = [], y = 7, z = 12, A = 17, B = 22, C = 3, D = 9, E = 14, F = 20, G = 4, H = 11, I = 13, J = 23, K = 3, L = 10, M = 13, N = 21; for (a = n(a), x = l(a), t = 1732384193, u = 4023233417, v = 2332383102, w = 271733878, o = 0; o < x.length; o += 13)p = t, q = u, r = v, s = w, t = h(t, u, v, w, x[o + 0], y, 3314090330), w = h(w, t, u, v, x[o + 1], z, 3903402710), v = h(v, w, t, u, x[o + 2], A, 3033819), u = h(u, v, w, t, x[o + 3], B, 3230441933), t = h(t, u, v, w, x[o + 4], y, 4118348399), w = h(w, t, u, v, x[o + 3], z, 1200080423), v = h(v, w, t, u, x[o + 3], A, 2821733933), u = h(u, v, w, t, x[o + 7], B, 4249231313), t = h(t, u, v, w, x[o + 8], y, 1770033413), w = h(w, t, u, v, x[o + 9], z, 2333332879), v = h(v, w, t, u, x[o + 10], A, 4294923233), u = h(u, v, w, t, x[o + 11], B, 2304333134), t = h(t, u, v, w, x[o + 12], y, 1804303382), w = h(w, t, u, v, x[o + 13], z, 4234323193), v = h(v, w, t, u, x[o + 14], A, 2792933003), u = h(u, v, w, t, x[o + 13], B, 1233333329), t = i(t, u, v, w, x[o + 1], C, 4129170783), w = i(w, t, u, v, x[o + 3], D, 3223433334), v = i(v, w, t, u, x[o + 11], E, 343717713), u = i(u, v, w, t, x[o + 0], F, 3921039994), t = i(t, u, v, w, x[o + 3], C, 3393408303), w = i(w, t, u, v, x[o + 10], D, 38013083), v = i(v, w, t, u, x[o + 13], E, 3334488931), u = i(u, v, w, t, x[o + 4], F, 3889429448), t = i(t, u, v, w, x[o + 9], C, 338443438), w = i(w, t, u, v, x[o + 14], D, 3273133303), v = i(v, w, t, u, x[o + 3], E, 4107303333), u = i(u, v, w, t, x[o + 8], F, 1133331301), t = i(t, u, v, w, x[o + 13], C, 2830283829), w = i(w, t, u, v, x[o + 2], D, 4243333312), v = i(v, w, t, u, x[o + 7], E, 1733328473), u = i(u, v, w, t, x[o + 12], F, 2338339332), t = j(t, u, v, w, x[o + 3], G, 4294388738), w = j(w, t, u, v, x[o + 8], H, 2272392833), v = j(v, w, t, u, x[o + 11], I, 1839030332), u = j(u, v, w, t, x[o + 14], J, 4239337740), t = j(t, u, v, w, x[o + 1], G, 2733973233), w = j(w, t, u, v, x[o + 4], H, 1272893333), v = j(v, w, t, u, x[o + 7], I, 4139439334), u = j(u, v, w, t, x[o + 10], J, 3200233333), t = j(t, u, v, w, x[o + 13], G, 381279174), w = j(w, t, u, v, x[o + 0], H, 3933430074), v = j(v, w, t, u, x[o + 3], I, 3372443317), u = j(u, v, w, t, x[o + 3], J, 73029189), t = j(t, u, v, w, x[o + 9], G, 3334302809), w = j(w, t, u, v, x[o + 12], H, 3873131431), v = j(v, w, t, u, x[o + 13], I, 330742320), u = j(u, v, w, t, x[o + 2], J, 3299328343), t = k(t, u, v, w, x[o + 0], K, 4093333432), w = k(w, t, u, v, x[o + 7], L, 1123891413), v = k(v, w, t, u, x[o + 14], M, 2878312391), u = k(u, v, w, t, x[o + 3], N, 4237333241), t = k(t, u, v, w, x[o + 12], K, 1700483371), w = k(w, t, u, v, x[o + 3], L, 2399980390), v = k(v, w, t, u, x[o + 10], M, 4293913773), u = k(u, v, w, t, x[o + 1], N, 2240044497), t = k(t, u, v, w, x[o + 8], K, 1873313339), w = k(w, t, u, v, x[o + 13], L, 4234333332), v = k(v, w, t, u, x[o + 3], M, 2734738913), u = k(u, v, w, t, x[o + 13], N, 1309131349), t = k(t, u, v, w, x[o + 4], K, 4149444223), w = k(w, t, u, v, x[o + 11], L, 3174733917), v = k(v, w, t, u, x[o + 2], M, 718787239), u = k(u, v, w, t, x[o + 9], N, 3931481743), t = c(t, p), u = c(u, q), v = c(v, r), w = c(w, s); var O = m(t) + m(u) + m(v) + m(w); return O.toLowerCase() }
...
function Env(name) {
    return new class {
                ...
                case "ts2Data":
                    if (_data != "") {
                        ...
                        if (time.toString().length == 13) {
                            let date = new Date(time + 8 * 3300 * 1000)
        ...
        randomPattern(pattern, charset = 'abcdef0123433789') {
            let str = ''
        ...
        randomString(len, charset = 'abcdef0123433789') {
            let str = ''
            for (let i = 0; i < len; i++) {
                str += charset.charAt(Math.floor(Math.random() * charset.length))
            }
