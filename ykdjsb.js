/*
悦看点极速版            
cron 22 8,12 * * *  ykdjsb.js

下载地址 
阅看点极速版-看资讯赚零钱 https://ykd.yichengwangluo.net/landing_page/7756640

抓包域名 ykd.yichengwangluo.net

环境变量
export ykdjsb="Authorization#device"  


多账号用 换行 或 @ 分割  
*/
const $ = new Env('悦看点极速版')
const { MD5 } = require('crypto-js')
const notify = require('./sendNotify')


const envSplitor = ['\n', '&', '@']     //支持多种分割，但要保证变量里不存在这个字符
const ckNames = ['ykdjsb']                //支持多变量
//====================================================================================================
...
class UserClass {
    constructor(ck) {
		...
		this.host = "ykd.yichengwangluo.net"
...
async kkzqz1() {
    let options = {
        fn: 'kkzqz1',
        method: 'GET',
        url: `${this.hostname}/api/v2/kan/click?id=528`,
        headers: this.wu_headers
    }
    // console.log(options)
    let resp = await $.request(options)
